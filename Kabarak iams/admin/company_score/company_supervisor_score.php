...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="company_supervisor_score.php"><li class="menu_items_list" style="background-color:#3CB4FB;padding-left:16px">Company Supervisor Score</li></a>
